...
HD_PWD='C:/Users/Eric_Zietz2/Box/SoC/Project1_Zietz/Project1_Zietz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ssegmain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ssegmain.tcl -notrace
