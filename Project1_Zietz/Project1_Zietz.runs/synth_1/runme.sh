...
HD_PWD='C:/Users/Eric_Zietz2/Box/SoC/Project1_Zietz/Project1_Zietz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ssegmain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ssegmain.tcl
